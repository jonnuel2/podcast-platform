...
export default function ListenerDashboard() {
  ...
  // Fetch user's uploaded episodes from Supabase
  useEffect(() => {
    fetchEpisodes();
  }, [account]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-orange-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {!account && (
          <div className="bg-orange-50 border-2 border-orange-500 rounded-xl p-8 text-center mb-8">
